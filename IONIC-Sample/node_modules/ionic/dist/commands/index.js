...
class IonicNamespace extends namespace_1.Namespace {
    constructor() {
        ...
        this.namespaces = new namespace_1.NamespaceMap([
            ...
            ['integrations', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { IntegrationsNamespace } = yield Promise.resolve().then(function () { return require('./integrations/index'); }); return new IntegrationsNamespace(); })],
        ]);
